  ...
  return (
    <div className="custom-heading">
      ...
      <label className={`${player==="ansem" ? "text-red-500" : "text-white"}`}>
          ...
          />{" "}
          Ansem
          <img className={`absolute right-[26%] scale-x-[60%] scale-[85%] top-[15%] ${player==="ansem" ? " brightness-100 -z-10" : "brightness-50 -z-20"}`} src={ansem}/>
        </label>
        <label className={`${player==="kook" ? "text-red-500" : "text-white"}`}>
          ...
          />{" "}
          Kook
          <img className={`absolute left-[27%] scale-[82%] top-[12%] ${player==="kook" ? "brightness-100 -z-10" : "brightness-50 -z-20"}`} src={kook}/>
        </label>
      </div>
