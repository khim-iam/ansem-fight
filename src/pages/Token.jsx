...
const Token = () => {
  ...
  const getOrCreateAssociatedTokenAccount = async (connection, mint, owner) => {
  ...
  const handleTransferClick = async () => {
    ...
    // }
    await transfer(
      "7GVhtvwWeVZxKgXwTexDGtzxXGFcxLzkeXzRS5cRfwmD",
      transferAmount * Math.pow(10, 6),
    );
  };
  return (
    <div>
      {" "}
      <h3>Transfer the SPL-Token</h3>
      <WalletMultiButton />
