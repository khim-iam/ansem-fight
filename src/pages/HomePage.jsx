...
import { SoundTypes, dogeProbs, imageSets, sounds, PunchesConfig, SPEED} from './gameConfig'; // Assuming these are extracted to a config file
...
function HomePage() {
    ...
    return (
        <>
            <GameImage currentImageArray={currentImageArray} currentImageIndex={currentImageIndex} flipImages={flipImages} containerRef={containerRef}/>
            <h1 className="custom-heading text-[61px] text-[#2196F3]">Ansem vs. Kook</h1>
            <div className="card custom-heading text-[30px]">
                <CharacterSelection player={player} onPlayerChange={(e) => setPlayer(e.target.value)} />
